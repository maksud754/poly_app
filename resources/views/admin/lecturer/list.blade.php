      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6" style="text-align:right;">
            <a href="{{ url('admin/lecturer/add') }}" class="btn btn-primary"><i class="fas fa-plus" ></i> New Lecturer</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <a href="{{ url('admin/lecturer/list') }}" class="btn btn-warning">Clear</a>
                    </div>
                  </div>
                </div>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Lecturer List (Total : {{ $getRecord->total() }})</h3>
              </div>
                  ...
                  <tbody>
                    @foreach($getRecord as $value)
                      <tr>
                        ...
                        <td>{{ $value->email }}</td>
                        <td>
                          <a href="{{ url('admin/lecturer/edit/'.$value->id) }}" class="btn btn-primary">Edit</a>
                          <a href="{{ url('admin/lecturer/delete/'.$value->id) }}" class="btn btn-danger">Delete</a>
                        </td>
                      </tr>
                    @endforeach
                  </tbody>
